...
_sys.path.insert(0, str(_pathlib.Path(__file__).parent.parent.parent))  # vendors/
from vocos.feature_extractors import FeatureExtractor, EncodecFeatures  # noqa: E402
from vocos.heads import FourierHead, ISTFTHead  # noqa: E402
from vocos.models import Backbone  # noqa: E402
try:
    from torch.cuda.amp import autocast
except ImportError:
    from torch.amp import autocast  # PyTorch ≥ 2.4
